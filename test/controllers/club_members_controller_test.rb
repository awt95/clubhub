...
class ClubMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create club_member" do
    assert_difference('ClubMember.count') do
      post club_members_url, params: { club_member: { clubid: @club_member.clubid, id: @club_member.id, isadmin: @club_member.isadmin, userid: @club_member.userid } }
    end
  ...
  test "should update club_member" do
    patch club_member_url(@club_member), params: { club_member: { clubid: @club_member.clubid, id: @club_member.id, isadmin: @club_member.isadmin, userid: @club_member.userid } }
